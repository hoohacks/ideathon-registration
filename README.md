...
| Page | Path | Collects |
| --- | --- | --- |
| Competitor registration | `/` and `/idea-x` | name, email, major, school year, skills, resume upload, dietary needs |
...
| Production | `https://hoohacks.github.io/idea-x/#/judge-registration` |
...
Served from the `gh-pages` branch at `hoohacks.github.io/idea-x`.
